    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <CardDataStats title="Tổng đơn hàng" total={totalOrders?.toString() ?? "loi"} rate="4.35%" levelUp>
                    <svg
                ...
                <CardDataStats title="Tổng doanh thu" total={formatPrice(totalRevenue ?? 0)} rate="0.43%" levelUp>
                    <svg
                        className="fill-primary dark:fill-white"
                        width="22"
                        height="16"
                ...
                <CardDataStats title="Tổng Sản Phẩm" total={totalProducts?.toString() ?? "loi"} rate="2.59%" levelUp>
                    <svg
                        className="fill-primary dark:fill-white"
                        width="22"
                        height="22"
                ...
                <CardDataStats title="Tổng Người Dùng" total={totalUsers?.toString() ?? "loi"} rate="0.95%" levelDown>
                    <svg
                        className="fill-primary dark:fill-white"
                        width="22"
                        height="18"
