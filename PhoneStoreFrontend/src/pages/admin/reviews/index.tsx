...
export default function Reviews() {
  ...
  const columns: ColumnsType<ReviewType> = [
    ...
    },
    {
      ...
      dataIndex: 'rating',
      key: 'rating',
      render: (rating) => <span className='text-yellow-500'>{rating} ★</span>
    },
    {
      title: 'Bình luận',
      dataIndex: 'comment',
    ...
    },
    {
      ...
      render: (hasImages, record) =>
        hasImages ? (
          <img src={record.images.split(';')[0]} alt='Review' className='w-10 h-10 rounded-md' />
        ) : (
  ...
  return (
    <>
      ...
      <Modal title='Thông tin khách hàng' open={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null}>
        {selectedUser && (
