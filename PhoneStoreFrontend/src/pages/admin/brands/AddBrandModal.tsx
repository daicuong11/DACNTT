import { useAddCategory } from '@/hooks/querys/category';
...
import { useAddBrand } from '@/hooks/querys/brand';
        ...
        <BaseModal isOpen={isOpen} onClose={onClose}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-end px-4 py-3 text-right border-t">
                    <SubmitButton text={addBrandMutation.isPending ? "Đang xử lý..." : "Thêm"} disabled={addBrandMutation.isPending} />
                </div>
            </form>
        </BaseModal >
    );
