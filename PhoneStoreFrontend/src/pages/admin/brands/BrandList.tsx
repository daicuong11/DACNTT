...
export default function BrandList() {
    ...
    const columns: ColumnsType<BrandType>  = [
        ...
        },
        {
            ...
            render: (imageUrl: string) => (
                <Image width={50} src={imageUrl} alt="Category Image" />
            ),
        },
        {
            title: "Thao tác",
    ...
    return (
        <>
            ...
            <Card title="Danh Sách Thương Hiệu" button={<div onClick={handleOpen} className="btn btn-primary capitalize">Thêm Thương Hiệu</div>}>
                <Table
